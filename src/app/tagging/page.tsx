    ...
    >
      <div className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              <div className="flex gap-2">
                ...
                <button
                  type="button"
                  disabled
                  title="Video upload will be available in a later pilot phase"
        ...
        <section className="rounded-lg border border-slate-200 bg-white p-5 shadow-sm">
          ...
          <p className="mt-1 text-sm leading-6 text-slate-600">Confirm the draft, correct it, flag uncertainty, or include it in a future report.</p>
          <div className="mt-4 flex flex-wrap gap-3">
            ...
            <button type="button" disabled={!analysis} onClick={() => { setIsEditing((current) => !current); setReviewStatus(isEditing ? "Edits retained in this local draft." : "Editing enabled. Review every change before saving."); }} className="rounded-md border border-slate-300 bg-white px-4 py-2 text-sm font-semibold text-slate-700 disabled:cursor-not-allowed disabled:opacity-40">{isEditing ? "Finish editing" : "Edit before saving"}</button>
            ...
            <button type="button" disabled={!analysis} onClick={() => setStatus("Draft added to the local report queue.")} className="rounded-md border border-slate-300 bg-white px-4 py-2 text-sm font-semibold text-slate-700 disabled:cursor-not-allowed disabled:opacity-40">Add to report</button>
          </div>
